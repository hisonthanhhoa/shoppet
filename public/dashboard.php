...
<?php
  ...
  $sql = "select * from quan_li_san_pham where tinh_trang = 1 and id_loai_san_pham=12 limit 8";
  $rs = mysqli_query($conn, $sql);
...
<nav aria-label="Page navigation example">
  <ul class="pagination justify-content-center">
    <li class="page-item">
      <a class="page-link" href="index.php?c=xem_san_pham&a=xem_tat_ca&id_loai_san_pham=12">xem tất cả</a>
    </li>
  </ul>
</nav>
